            ...
            success: function(data) {
                ...
                if (data.is_secret == true) {
                    ...
                    if (data.write_auth == true) {
                        aHtml.push('<a href="/board/product/modify.html?board_act=edit&no=' + data.no + '&board_no=4&link_product_no=' + iProductNo + '" class="btnNormal mini"><img src="//img.echosting.cafe24.com/skin/mobile_en_US/board/btn_comment_modify.png" width="13" height="13" alt="Edit"></a>');
                    }
                    aHtml.push('</div>');
                        ...
                        for (var i=0; data.comment.length > i; i++) {
                            ...
                            if (data.comment[i]['comment_reply_css'] == undefined) {
                                ...
                                if (data.comment[i]['comment_reply_display'] == true) {
                                    ...
                                    aHtml.push('<a href="#none" class="btnNormal mini" onclick="REVIEW.comment_reply_view('+data.comment[i]['comment_no']+')"><img src="//img.echosting.cafe24.com/skin/mobile_en_US/board/btn_comment_view.png" width="13" height="13" alt="Reply to Comment"> <em>('+data.comment[i]['comment_reply_count']+')</em></a>');
                    ...
                    if (data.comment_write != undefined) {
                        ...
                        aHtml.push('<div class="captcha ' +data.comment_write['use_captcha']+ '"><span class="img"></span><div class="form">' +data.comment_write['captcha_image']+data.comment_write['captcha_refresh']+data.comment_write['captcha']+ '<p>Enter without any spaces. <br>(Case sensitive)</p></div></div>');
                    ...
                    if (data.comment_reply != undefined) {
                        ...
                        aHtml.push('<div class="captcha ' +data.comment_reply['use_captcha']+ '"><span class="img"></span><div class="form">' +data.comment_reply['captcha_image']+data.comment_reply['captcha_refresh']+data.comment_reply['captcha']+ '<p>Enter without any spaces. <br>(Case sensitive)</p></div></div>');
