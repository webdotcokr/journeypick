...
$(function(){
        ...
        show: function(overNode, iCateNo) {
            ...
            if (methods.aSubCategory[iCateNo] != undefined) {
                ...
                $(methods.aSubCategory[iCateNo]).each(function() {
                    ...
                    if (methods.aSubCategory[sNextParentNo] != undefined)  aHtml.push('<a href="/product/list_thumb.html'+this.param+'" class="view">See Product</a>');
                    aHtml.push('<button type="button" class="icoBookmark'+sCateSelected+'" id="icoBookmark">Add to Favorite</button>');
            ...
            if (sMyCateList != null && sMyCateList != "") {
                ...
                for (var i = 0; i < aTempList.length; i++) {
                    if (aTempList[i] != "") {
                        ...
                        aHtml.push('<li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">Remove from Favorite</button></li>');
    ...
    var offCover = {
        init : function() {
            $(function() {
               $('#wrap').append('<a href="#container" id="btnFoldLayout">Menu Toggle</a>');
                offCover.resize();
    ...
    $('#header .fold, #aside .btnClose').on('click', function(e){
        $('#dimmedSlider').toggle();
    ...
    $(document).on('click', '#btnFoldLayout', function(e) {
...
function setMyCateList(iCateNo, oObj) {
    ...
    if (checkInArray(sMyCateList, iCateNo) == true) {
        ...
        var sHtml = '';
        if (sMyCateList == null || sMyCateList == '') {
            sHtml = '<ul><li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">Remove from Favorite</button></li></ul>'
            $('#bookmarkCategory #bookmartCateArea').append(sHtml);
        } else {
            sHtml = '<li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">Remove from Favorite</button></li>'
